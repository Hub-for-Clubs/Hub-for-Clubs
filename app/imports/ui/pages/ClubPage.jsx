          ...
          <div className="profile">
            <Grid>
              <Grid.Column width={4} className="user_info">
                <Image className="profile_picture" src={(this.props.clubs.image !== 'N/A') ?
                    this.props.clubs.image : 'https://pbs.twimg.com/profile_images/1052001602628857856/AGtSZNoO_400x400.jpg'}
                       alt={'Club Picture'}
                       size="medium"/>
                  ...
                  <Card.Group>
                    ...
                    {activeItem === 'About-Us' ?
                        <Container>
                          ...
                          {this.props.announcements.reverse().map((announcement, index) => (this.props.clubs.name === announcement.club) ? <AnnouncementPost key={index} announcement={announcement}/> : '')}
                        </Container>
                        :
                        // eslint-disable-next-line no-nested-ternary
                        activeItem === 'Members' ?
